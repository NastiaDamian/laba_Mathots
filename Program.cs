...
class Calculator
{
    ...
    static void Main()
    {
        ...
        Console.WriteLine($"2. {numberToCheck} просте число {isPrime}");
        ...
        Console.WriteLine($" Найменший елемент: {minMax.Item1}");
        ...
        static Tuple<int, int> FindMinMax(int[] arr)
        {
            ...
            {
                throw new ArgumentException("Масив не має бути пустим або дорівнювати нулю");
            }
        ...
        Console.WriteLine($"Кiлькiсть голосних Hello, World! {counts.Item1}");
        ...
        static Tuple<int, int> CountVowelsAndConsonants(string input)
        {
            ...
            {
                throw new ArgumentException("Рядок не має бути пустим або дорівнювати нулю");
            }
